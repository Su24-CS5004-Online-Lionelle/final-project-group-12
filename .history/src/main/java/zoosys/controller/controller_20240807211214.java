...
public class controller {
     ...
     * @param responsibilities the responsibilities of the employee (comma-separated)
     */
    ...
    public void scheduleShift(String name, String shift) {
        if (name != null && !name.isEmpty() && shift != null && !shift.isEmpty()) {
    ...
    public void assignResponsibility(String name, String responsibility) {
        if (name != null && !name.isEmpty() && responsibility != null && !responsibility.isEmpty()) {
            employeeManagement.assignResponsibility(name, responsibility);
        }
    }

    /**
     * Print all the details of the employees.
     * 
     * @param name the name of the employee
     */
    ...
    public void setFoodInTrough(int foodInTrough) {
        enclosureManagement.setFoodInTrough(foodInTrough);
    }
